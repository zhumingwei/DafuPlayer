package com.zhumingwei.comic.medialibrary.widget;
...
public class MediaItemLayout extends SquareFrameLayout implements View.OnClickListener {
    ...
    private ImageView mImagePreivew;
    ...
    private void init(Context context) {
        ...
        mImagePreivew = (ImageView) findViewById(R.id.iv_preview);
        mThumbnail.setOnClickListener(this);
        mImagePreivew.setOnClickListener(this);
    }
